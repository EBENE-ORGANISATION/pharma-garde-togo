...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PharmaGarde — Pharmacies la plus proche au Togo" },
      { property: "og:description", content: "Trouvez rapidement les pharmacies ouvertes et les numéros d'urgence au Togo." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "PharmaGarde — Pharmacies la plus proche au Togo" },
      { name: "twitter:description", content: "Trouvez rapidement les pharmacies ouvertes et les numéros d'urgence au Togo." },
